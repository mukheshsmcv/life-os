...
export default function CalendarScreen() {
  ...
  const { tasks, completeTask, skipTask, getEventsForDate } = useTasks();
...
const styles = StyleSheet.create({
  ...
  eventCard: { borderColor: '#302A50' },
  cardDone: { opacity: 0.5 },
  cardUnscheduled: { backgroundColor: '#0F1115', borderColor: '#1E2228' },
  stripe: { width: 4 },
  cardBody: { flex: 1, padding: 12 },
  cardTitleRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', gap: 8 },
  cardTitle: { color: '#E8E9EC', fontSize: 14, fontWeight: '600', flex: 1 },
  cardTitleDone: { color: '#4A5060', textDecorationLine: 'line-through' },
  cardMeta: { color: '#4A5060', fontSize: 11, marginTop: 4 },
  ...
  eventBadgeText: { color: '#FCD34D', fontSize: 9, fontWeight: '700', letterSpacing: 0.5 },
  taskBadge: {
  ...
  taskBadgeText: { color: '#A7A0FF', fontSize: 9, fontWeight: '700', letterSpacing: 0.5 },
  ...
  freeTimeTime: { color: '#303640', fontSize: 11, fontWeight: '600', width: 66, textAlign: 'right' },
  freeTimeLine: { flex: 1, height: 1, backgroundColor: '#1A1E24', borderStyle: 'dashed' },
  freeTimeLabel: { color: '#303640', fontSize: 11, fontWeight: '500' },
});
