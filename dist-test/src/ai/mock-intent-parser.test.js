...
function runParserTests() {
    ...
    for (const test of allTests) {
        const res = (0, mock_intent_parser_1.parseIntent)(test.input);
        if (!res.success) {
        ...
        if (action.type !== test.expectedType) {
            console.error(`FAIL: "${test.input}" expected type "${test.expectedType}", got "${action.type}"`);
            failed++;
            continue;
        }
        if (test.expectedQueryOrTitle !== undefined) {
            ...
            if (extracted !== test.expectedQueryOrTitle) {
                console.error(`FAIL: "${test.input}" expected query/title "${test.expectedQueryOrTitle}", got "${extracted}"`);
                failed++;
                continue;
            }
        }
    ...
    const caseA = (0, mock_intent_parser_1.parseIntent)("Study pathology tomorrow for 2 hours.");
    ...
    const caseB = (0, mock_intent_parser_1.parseIntent)("Study pathology tomorrow at 9 AM for 2 hours.");
    ...
    const caseC = (0, mock_intent_parser_1.parseIntent)("Study pathology tomorrow at 9 AM for 2 hours, then anatomy at 1 PM for 1 hour.");
    if (caseC.success &&
    ...
    const caseD = (0, mock_intent_parser_1.parseIntent)("Schedule pathology at 9:30 AM today.");
    ...
    const caseE = (0, mock_intent_parser_1.parseIntent)("Move pathology to tomorrow at 3 PM.");
    ...
    const caseF = (0, mock_intent_parser_1.parseIntent)("Make pathology anytime tomorrow.");
    ...
    const caseG = (0, mock_intent_parser_1.parseIntent)("Doctor appointment tomorrow at 10 AM.");
    if (caseG !== undefined) {
        passed++;
    }
    else {
    ...
    const step1 = (0, mock_intent_parser_1.parseIntent)("Reschedule Study Pharmacology to another day");
    ...
    const step2 = (0, mock_intent_parser_1.parseIntent)("Yes tomorrow", { pendingClarification: step1.pendingClarification });
    ...
    const step3 = (0, mock_intent_parser_1.parseIntent)("12pm", { pendingClarification: step2.pendingClarification });
    if (step3.success &&
    ...
    const oneTurn = (0, mock_intent_parser_1.parseIntent)("Move pathology to tomorrow at 12pm");
    ...
    const t7pm = (0, mock_intent_parser_1.parseIntent)("Schedule surgery at 7pm");
    ...
    const t12pm = (0, mock_intent_parser_1.parseIntent)("Schedule surgery at 12pm");
    ...
    // 7. "12am" produces 0
    const t12am = (0, mock_intent_parser_1.parseIntent)("Schedule surgery at 12am");
    ...
    const t730pm = (0, mock_intent_parser_1.parseIntent)("Schedule surgery at 7:30pm");
    ...
    const inability1 = (0, mock_intent_parser_1.parseIntent)("Not able to do pharmacology today", { tasks: sampleContextTasks });
    ...
    const inability2 = (0, mock_intent_parser_1.parseIntent)("Yes", { tasks: sampleContextTasks, pendingClarification: inability1.pendingClarification });
    ...
    const inability3 = (0, mock_intent_parser_1.parseIntent)("Reschedule it to Tuesday", { tasks: sampleContextTasks, pendingClarification: inability2.pendingClarification });
    ...
    const inability4 = (0, mock_intent_parser_1.parseIntent)("4 pm", { tasks: sampleContextTasks, pendingClarification: inability3.pendingClarification });
    ...
    const singleFollowUp = (0, mock_intent_parser_1.parseIntent)("Yes to Tuesday at 4 pm", { tasks: sampleContextTasks, pendingClarification: inability1.pendingClarification });
    ...
    const partialCase = (0, mock_intent_parser_1.parseIntent)("not able to do PHARMACOLOGY today", { tasks: sampleContextTasks });
    ...
    const singleTurnMove = (0, mock_intent_parser_1.parseIntent)("Move Study Pharmacology to Tuesday at 4 pm", { tasks: sampleContextTasks });
    ...
    const newCmd = (0, mock_intent_parser_1.parseIntent)("add gym for 1 hour", { tasks: sampleContextTasks, pendingClarification: inability1.pendingClarification });
    ...
    const multiMatch = (0, mock_intent_parser_1.parseIntent)("Not able to do pharmacology today", { tasks: multiTasks });
    ...
    const ftTomorrow = (0, mock_intent_parser_1.parseIntent)("What's my free time tomorrow?", mockContext);
    ...
    const schTomorrow = (0, mock_intent_parser_1.parseIntent)("What's my schedule tomorrow?", mockContext);
    ...
    const doingTomorrow = (0, mock_intent_parser_1.parseIntent)("What am I doing tomorrow?", mockContext);
    ...
    const ftToday = (0, mock_intent_parser_1.parseIntent)("What's my free time today?", mockContext);
    ...
    const ftMonday = (0, mock_intent_parser_1.parseIntent)("How much free time do I have Monday?", mockContext);
    ...
    const whenPharm = (0, mock_intent_parser_1.parseIntent)("When can I study pharmacology tomorrow?", mockContext);
    ...
    const defaultSch = (0, mock_intent_parser_1.parseIntent)("what's my schedule?", mockContext);
    ...
    for (const alias of nextAliases) {
        const res = (0, mock_intent_parser_1.parseIntent)(alias, mockContext);
    ...
    for (const fq of fullQueries) {
        const res = (0, mock_intent_parser_1.parseIntent)(fq, mockContext);
        if (res.success && res.actions[0]?.type === 'get_schedule' && res.actions[0].payload?.scope !== 'next') {
            passed++;
        }
        else {
